...
#define EVENT_CLASS_CATEGORY(category) virtual int GetCategoryFlags() const override { return category; }
	...
	public:
		...
		virtual std::string ToString() const { return GetName(); }		// Only for debugging purpose
	...
	// Easily print event information for whatever event to the preferred output stream (console, file...)
